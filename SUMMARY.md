...
* [Liker ID](depub/liker-id/README.md)
  * [Register through Email/Social (with Authcore)](depub/liker-id/register/README.md)
    * [Securing your Liker ID](depub/liker-id/register/verifying-email-address.md)
    * [Connecting to my social account](depub/liker-id/register/social-media-logins.md)
    * [Resetting password](depub/liker-id/register/reset-password.md)
    * [Manage logged in devices](depub/liker-id/register/devices.md)
    * [Export Wallet Seed Words](depub/liker-id/register/export-seed-words.md)
    * [What is Authcore?](depub/liker-id/register/what-is-authcore.md)
  * [Register a Liker ID with Keplr](depub/liker-id/register-with-keplr.md)
  * [Edit Avatar and Name](depub/liker-id/edit-avatar-displayname.md)
