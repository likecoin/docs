# Set up a node (mainnet / public testnet)
...
2. Synchronize the node to the latest block
3. Create operator account
4. Create validator

## Secure The Host

Refer to [Node Security](./setup-a-node/node-security.md) page.
...
Next, we will create the validator.
...
If you insist to setup a new validator this way, you may refer to the [old docker setup guide](./setup-a-node/setup-on-docker.md)

## Further Reading

- [Node Configuration](https://docs.like.co/validator/likecoin-chain-node/node-configuration)
- [Useful Commands](https://docs.like.co/validator/likecoin-chain-node/command-line-interface/useful-commands)
