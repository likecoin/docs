...
{% hint style="warning" %}
Once a Liker ID has been created, it cannot be changed.  We suggest you keep it, or just create another one. Please note that a email address can only register a Liker ID.
{% endhint %}
