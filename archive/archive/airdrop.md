...
ATOM/OSMO 持有人、委託人或流動性提供者及[以 Keplr 註冊 Liker ID](../../general-guides/dapp/liker-id/register-with-keplr.md) 的用戶可全程直接使用桌面電腦領取空投。

[以一般方法 ( Authcore ) 註冊 Liker ID](../../depub/register/) 的讚賞公民用戶，請預備 Liker Land app 及桌面電腦領取空投。
...
你可以通過 [Keplr](../../general-guides/dapp/liker-id/register-with-keplr.md) 或 [Liker Land app](../../depub/register/) 管理你的 LikeCoin。 你可以使用 LIKE [去中心出版 DePub](../../depub/decentralized-publishing.md)，在交易所[交易](../../general-guides/trade/)、[委託](../../general-guides/stake/)獲得獎勵、[投票](../../general-guides/governance/direct-vote/)參與治理及[獎勵創作者](../../general-guides/dapp/liker-land/like.md)。
...
到 [https://dao.like.co/validators](https://dao.like.co/validators) 並連接 [Keplr](../../general-guides/dapp/liker-id/register-with-keplr.md) 或 [Authcore](../../depub/register/)。 將任何數量的 LikeCoin [委託](../../general-guides/stake/)給「Validators」頁面中至少一位[驗證人](../../general-guides/governance/what-is-a-validator/)。
...
到 [https://dao.like.co/proposals/](https://dao.like.co/proposals/) 並連接你的 [Keplr](../../general-guides/dapp/liker-id/register-with-keplr.md) 或 [Authcore](../../depub/register/)。 在「Proposals」頁面中，對其中一項議案進行投票。
