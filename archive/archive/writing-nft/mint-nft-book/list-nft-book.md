...
請先登入你的 [Keplr](../../../../general-guides/wallet/keplr/)，並於 [LikeCoin NFT Book Press](https://likecoin.github.io/nft-book-press) 選 [Manage NFT Books](https://likecoin.github.io/nft-book-press/nft-book-store)，再點右上角「Connect」連接 Keplr。在 New NFT Book Listing 頁面輸入以下資料：
