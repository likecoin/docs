...
# 使用 LikeCoin app 以文章網址出版 Writing NFT
...
假如文章並未註冊 [ISCN](../../../depub/what-is-iscn/)，請直接把文章網址輸入空格並點「Register ISCN」。
...
出現 Completed! 及 3D 封面圖即代表 NFT 已鑄造完成，如網站未曾安裝 [LikeCoin button 讚賞鍵](../../../user-guide/creator/)可直接貼上 Embed NFT widget into your site 的代碼，即可在任何網頁展示 [NFT 小部件](../../../depub/nft-portal/nft-widget.md)。
...
**如希望作品擁有詳盡元數據，請先** [**註冊 ISCN**](../../../depub/what-is-iscn/app.like.co/) **再**[**以 ISCN ID 出版 Writing NFT**](../../../depub/nft-portal/iscn-id.md)**。**&#x20;
{% endhint %}
