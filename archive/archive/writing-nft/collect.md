...
彈出視窗出現 [Keplr](../../../general-guides/wallet/keplr/)，點擊登入。
...
{% hint style="info" %}
擁有 [Cosmostation](../../../general-guides/wallet/cosmostation/)、[Leap](../../../general-guides/wallet/leap/)、[Cosmostation app](../../../general-guides/wallet/cosmostation-mobile/) 或 [Liker ID](../../../user-guide/liker-land/download.md) 的用戶也可以使用信用卡購買 Writing NFT，只需在登入時採用對應的登入方式即可。
{% endhint %}
