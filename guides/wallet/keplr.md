...
假如你的 Keplr 錢包未能顯示 LikeCoin chain，請[先到 dao.like.co 為 Keplr 錢包連結 LikeCoin chain](keplr.md#use-stake.like.co-to-check-likecoin-transaction-details-transfer-or-delegate)。
