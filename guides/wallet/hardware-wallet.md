...
以下示範採用 [Big Dipper](https://docs.like.co/v/zh/guides/governance/big-dipper) 區塊鏈瀏覽器進行，你也可以使用 [Keplr](https://docs.like.co/v/zh/guides/wallet/keplr) 配合硬體錢包管理你的 LikeCoin。
