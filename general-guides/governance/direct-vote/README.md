...
There are multiple ways to vote for a proposal, **we suggest using** [stake.like.co](https://stake.like.co/welcome) together with [Keplr Browser Extension](../../wallet/keplr/), [Cosmostation Browser Extension](../../wallet/cosmostation/) or [Authcore](../../../depub/register/).&#x20;
...
Using a mobile browser with [stake.like.co](https://stake.like.co/welcome) can vote by [Authcore](../../../depub/register/).
