...
There are several ways to deposit for a proposal, but we suggest using [stake.like.co](https://stake.like.co/welcome) in conjunction with the [Keplr Browser Extension](../wallet/keplr/), [Cosmostation Browser Extension](../wallet/cosmostation/) or [Authcore](../../depub/register/).
...
Go to [stake.like.co](https://stake.like.co/welcome) and select [Keplr Browser Extension](../wallet/keplr/), [Cosmostation Browser Extension](../wallet/cosmostation/) or [Authcore](../../depub/register/) to log in. Note that Keplr Browser Extension and Cosmostation Browser Extension can only be used in desktop browsers, while Authcore is suitable for both desktop and mobile devices.
