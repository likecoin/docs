...
存入保證金的方式有多種，我們建議使用 [stake.like.co](https://stake.like.co/welcome) 配合 [Keplr Browser Extension](../wallet/keplr/)、[Cosmostation Browser Extension](../wallet/cosmostation/) 或 [Authcore](../../depub/register/)。
...
到 [stake.like.co](https://stake.like.co/welcome) 網站選擇 [Keplr Browser Extension](../wallet/keplr/)、[Cosmostation Browser Extension](../wallet/cosmostation/) 或 [Authcore](../../depub/register/) 登入。留意 Keplr 與 Cosmostaiton 只可於桌機瀏覽器中使用，Authcore 則桌機手機兩相宜。
