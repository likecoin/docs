...
請於桌面電腦瀏覽器登入 [Cosmostation 瀏覽器擴充功能](../../wallet/cosmostation/)後，直接進入 [**NFT Portal** ](https://app.like.co/nft/url)並選擇以 Cosmostation 登入網站。
...
**如希望作品擁有詳盡元資料，請先** [**註冊 ISCN**](../../decentralized-publishing/app.like.co.md) **再**[**以 ISCN ID 出版 Writing NFT**](by-iscn-id.md)**。**&#x20;
{% endhint %}
