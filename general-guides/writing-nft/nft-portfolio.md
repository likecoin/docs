...
Portfolio page lists all NFTs and their asset values. It is the place where user can transfer NFT and sell them to the secondary market.
...
Click the icon on the top right hand corner and copy the URL easily, and you can choose to sort the NFT by value or time.

<figure><img src="../../.gitbook/assets/NFT Portfolio.png" alt=""><figcaption><p>NFT Portfolio: Show your NFT collection, transfer NFT and sell to secondary market</p></figcaption></figure>
