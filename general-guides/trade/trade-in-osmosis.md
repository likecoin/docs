...
2021 年 10 月 20 日開始你可在 Osmosis 去中心交易所 ( DEX )，以 [LikeCoin](https://like.co/) 交易包括美元穩定幣 $USDC 在內的數十種貨幣。過程無需註冊、不設入金出金門檻、用戶只需一個電子錢包即可操作，全程去中心化。
...
<figure><img src="../../.gitbook/assets/purchase likecoin 3.png" alt=""><figcaption><p>輸入需要購買的 OSMO 數量，點「Buy Now」</p></figcaption></figure>

出現你的錢包地址、購買的 OSMO 數量、手續費等資訊，確認無誤後點「Buy OSMO」。

<figure><img src="../../.gitbook/assets/purchase likecoin 4.png" alt=""><figcaption><p>確認資料，點「Buy OSMO」</p></figcaption></figure>

輸入你的電郵地址再點「Continue」。

<figure><img src="../../.gitbook/assets/purchase likecoin 5.png" alt=""><figcaption><p>輸入電郵地址再點「Continue」</p></figcaption></figure>

在電郵收到驗證碼 ( Verification Code ) 後，輸入並點「Continue」。

<figure><img src="../../.gitbook/assets/Osmosis 8.png" alt=""><figcaption><p>電郵接收驗證碼</p></figcaption></figure>

<figure><img src="../../.gitbook/assets/Osmosis 9.png" alt=""><figcaption><p>輸入驗證碼後點「Continue」</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Osmosis 10.png" alt=""><figcaption><p>輸入名字、姓氏、手機號碼、出生日期再點「Continue」</p></figcaption></figure>

#### KYC STEP 2/3

輸入你的地址 ( Address Line )、額外地址資料 ( Address Line 2 )、地區 ( State/Region )、城市 ( City )、郵遞區號 ( Postal/Zip Code )、國家 ( Country ) 再點「Continue」。

<figure><img src="../../.gitbook/assets/Osmosis 11.png" alt=""><figcaption><p>輸入你的地址、額外地址資料、地區、城市、郵遞區號、國家再點「Continue」</p></figcaption></figure>

#### KYC STEP 3/3

提供你的證件進行身份認證，你可以直接使用電腦的視像鏡頭 ( Take photo using webcam ) 或轉到手機繼續 ( Continue on mobile )。

<figure><img src="../../.gitbook/assets/Osmosis 12.png" alt=""><figcaption><p>使用電腦的視像鏡頭或轉到手機進行身份認證</p></figcaption></figure>

如使用手機繼續，可選擇輸入電郵並傳送連結到手機 ( Send link by email ) 或掃瞄 QR Code 繼續 ( Scan QR code instead )。

<figure><img src="../../.gitbook/assets/Osmosis 13.png" alt=""><figcaption><p>如使用手機繼續，可選擇輸入電郵並傳送連結到手機或掃瞄 QR Code 繼續</p></figcaption></figure>

以傳送連結到手機為例，收到電郵後在手機中點「here」繼續。

<figure><img src="../../.gitbook/assets/Osmosis 14.png" alt=""><figcaption><p>收到電郵後在手機中點「here」繼續</p></figcaption></figure>

在手機中點「Start」開始，拍攝證件正面圖片 ( Front of identity card )，上傳並點「Confirm」。

<figure><img src="../../.gitbook/assets/Osmosis 15.png" alt=""><figcaption><p>在手機中點「Start」開始，拍攝證件正面圖片，上傳並點「Confirm」</p></figcaption></figure>

點「Start」拍照證件背面圖片 ( Back of identity card ) 上傳並點「Confirm」。

<figure><img src="../../.gitbook/assets/Osmosis 16.png" alt=""><figcaption><p>點「Start」拍照證件背面圖片上傳並點「Confirm</p></figcaption></figure>

點「Start」進行人面辨識 ( Face verification )，完成後出現 Check your desktop 回到桌面電腦。

<figure><img src="../../.gitbook/assets/Osmosis 17.png" alt=""><figcaption><p>點「Start」進行人面辨識，完成後出現 Check your desktop 回到桌面電腦</p></figcaption></figure>

顯示黃色感嘆號畫面，代表資料經已上載完畢。等待五至十分鐘即可完成身份認證。

<figure><img src="../../.gitbook/assets/Osmosis 18.png" alt=""><figcaption><p>五至十分鐘後完成身份認證</p></figcaption></figure>

出現 Your profile has been verified. 代表認證完畢，點「Order Now」繼續。

<figure><img src="../../.gitbook/assets/Osmosis 19.png" alt=""><figcaption><p>出現 Your profile has been verified. 代表認證完畢，點「Order Now」繼續</p></figcaption></figure>

輸入帳單地址 ( Billing Address )，留意這個地址必須與使用的信用卡地址相同，完成後點「Continue」。

<figure><img src="../../.gitbook/assets/Osmosis 20.png" alt=""><figcaption><p>輸入帳單地址，完成後點「Continue」</p></figcaption></figure>

輸入你的信用卡資料，再點「Add Card」。

<figure><img src="../../.gitbook/assets/Osmosis 21.png" alt=""><figcaption><p>輸入信用卡資料，再點「Add Card」</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Osmosis 24.png" alt=""><figcaption><p>在 Keplr 錢包看到已購買的 OSMO</p></figcaption></figure>

### 步驟三：將 OSMO 交換為 LIKE

點圖片或「Swap in Osmosis」直接跳轉到 Osmosis 的 Swap 頁面並出現 OSMO 轉換將為 LIKE 的設定。

<figure><img src="../../.gitbook/assets/purchase likecoin 6.png" alt=""><figcaption><p>點圖片或「Swap in Osmosis」直接跳轉到 Osmosis 的 Swap 頁面</p></figcaption></figure>

輸入需要兌換的數量，在下方點開查看兌換率、需要付出的互換交易費用 ( Swap Fee )，以及預計所得到的 LIKE 數量 ( Expected Output )。查看無誤後點「Swap」進行交易。
...
### 步驟四：將 LIKE 由 Osmosis 提取到 LikeCoin chain

點圖片或「Withdraw in Osmosis」直接跳轉到 Osmosis 的 Assets 頁面。

<figure><img src="../../.gitbook/assets/purchase likecoin 7.png" alt=""><figcaption><p>點圖片或「Withdraw in Osmosis」直接跳轉到 Osmosis 的 Assets 頁面</p></figcaption></figure>

在 Assets 頁面可看到換幣完成後 LIKE 增加了。點「Withdraw >」出現 Withdraw LIKE 畫面，在 Select Amount 輸入需要提取的 LIKE 數量，再點「Withdraw LIKE」即可提取 LIKE 回到  LikeCoin chain。

<figure><img src="../../.gitbook/assets/Osmosis 27.png" alt=""><figcaption><p>換幣完成後 LIKE 增加了，點「Withdraw >」</p></figcaption></figure>

<figure><img src="../../.gitbook/assets/Osmosis 28.png" alt=""><figcaption><p>點「Withdraw LIKE」</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Osmosis 3.png" alt=""><figcaption><p>出現錢包名稱及經已擁有的 OSMO 數量</p></figcaption></figure>

### 步驟二：連接 Transak

點左下角的「Buy tokens」開始在 Transak 的購幣程序。

<figure><img src="../../.gitbook/assets/Osmosis 4.png" alt=""><figcaption><p>點左下角「Buy tokens」</p></figcaption></figure>

輸入需要購買的 OSMO 數量後點「Buy Now」。

<figure><img src="../../.gitbook/assets/Osmosis 5.png" alt=""><figcaption><p>輸入需要購買的 OSMO 數量，點「Buy Now」</p></figcaption></figure>

出現你的錢包地址、購買的 OSMO 數量、手續費等資訊，確認無誤後點「Buy OSMO」。

<figure><img src="../../.gitbook/assets/Osmosis 6.png" alt=""><figcaption><p>確認資料，點「Buy OSMO」</p></figcaption></figure>

輸入你的電郵地址再點「Continue」。

<figure><img src="../../.gitbook/assets/Osmosis 7.png" alt=""><figcaption><p>輸入電郵地址再點「Continue」</p></figcaption></figure>
...
回到 Osmosis 主頁選 Swap，並選擇 OSMO 轉換將為 LIKE。輸入需要兌換的數量，在下方點開查看兌換率、需要付出的互換交易費用 ( Swap Fee )，以及預計所得到的 LIKE 數量 ( Expected Output )。查看無誤後點「Swap」進行交易。
...
<figure><img src="../../.gitbook/assets/Osmosis 29.png" alt=""><figcaption><p>到左手邊菜單選 Assets 找到 LikeCoin - LIKE 後點「Deposit >」將 LIKE 存進 Osmosis</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/Osmosis 32.png" alt=""><figcaption><p>Osmosis 右上角彈出視窗，到最後出現 IBC Transfer Complete 即代表成功將 LIKE 存進 Osmosis</p></figcaption></figure>
