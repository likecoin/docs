...
The following demo is on the block explorer [Big Dipper](https://docs.like.co/guides/governance/big-dipper) environment, you may also manage your LikeCoin with hardware wallet on [Keplr](https://docs.like.co/guides/wallet/keplr).
