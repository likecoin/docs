...
以下示範採用 [Big Dipper](block-explorer/big-dipper.md) 區塊鏈瀏覽器進行，你也可以使用 [Keplr](keplr/) 配合硬件錢包管理你的 [LikeCoin](https://like.co/)，詳見 [How to use Ledger Nano hardware wallet with Keplr](https://medium.com/chainapsis/how-to-use-ledger-nano-hardware-wallet-with-keplr-9ea7f07826c2)。
