...
![Super Like](../../../.gitbook/assets/likecoin_ad92_super_like_dragonball.png)

## 概念

點[讚賞鍵](../creator/)第六下，將自動分享文章到去中心社交媒體 [depub.space](../depub.space/)，提升高質內容的曝光度，推文永存於區塊鏈。

​[LikeCoin app](https://docs.like.co/v/zh/user-guide/liker-land/download) 顯示 depub.space 的 World Feed。
...
depub.space 是 LikeCoin 生態內的去中心社交媒體，每則推文都是一筆鏈上記錄，只需以 [Keplr](../../wallet/keplr/) 或 [Cosmostation 瀏覽器擴充功能錢包](../../wallet/cosmostation/)登入或使用 [LikeCoin app](download.md) 進行 Wallet Connect 即可發文，無需註冊，預設私隱。
...
目前使用 depub.space 必須透過桌面電腦的 Keplr 或 Cosmostation 瀏覽器插件或 LikeCoin app 接駁 Wallet Connect，暫無手機方案。

## 使用方法

* 在讚賞鍵點 5 次，讚賞鍵的圖案會從拍掌圖案轉變成星形圖案，這時再點第 6 次，便使用了 Super Like。
* 被 Super Like 了的文章會顯示在 LikeCoin app 及 depub.space 上。
