...
To become a Civic Liker, you must first purchase LikeCoin. Currently, [Osmosis](../../trade/trade-in-osmosis.md) is the DEX with the highest circulation, where you can exchange LikeCoin for other 30s cryptocurrencies. You can also check out the "[Buy LikeCoin](../../trade/buy-likecoin.md)" section.
...
For a detailed explanation of the delegation rewards, please refer to [this article](../../stake/where-comes-the-likecoin-rewards.md).

### **14.** What if I want to support creators with direct payment?

You can transfer LikeCoin directly to the creator's account. Please refer to [this article](../../wallet/like-pay.md) for the transfer method.
