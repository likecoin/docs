...
<summary><a href="../../trade/buy-likecoin.md"><strong>購買 5,000 LIKE</strong></a></summary>
...
到 [stake.like.co](https://stake.like.co/welcome) 網站後選 [Keplr Browser Extension](../../wallet/keplr/)、[Cosmostation Browser Extension](../../wallet/cosmostation/) 或 [Authcore](../../../depub/register/) 登入已連結了 Liker ID 的錢包。
...
步驟詳見[以手機委託 LikeCoin 章節](../../stake/delegation-of-likecoin/on-mobile.md)，選取名稱為 Civic Liker 讚賞公民節點進行委託即可。
...
{% hint style="warning" %}
假如用戶經已委託了給別的驗證人，請善用[轉移委託](../../stake/redelegation-of-likecoin/)，而不是取回委託功能，否則需要等待 21 天冷卻期方可重新動用資金。
{% endhint %}
