...
[depub.space](https://depub.space/) 是 Web3 去中心化 [Twitter](https://twitter.com/)，只需要付出少量 [LikeCoin](https://like.co/) 就可直接將文字及圖片 “DePub”（去中心出版）至 [IPFS](https://ipfs.tech/) 及區塊鏈，非常方便。用戶可以使用 [Keplr](../../wallet/keplr/)、[Cosmostation 瀏覽器錢包](../../wallet/cosmostation/)及 [LikeCoin app](../liker-land/download.md) 經 Wallet Connect 接駁 depub.space 直接發文。
...
請先登入 [Keplr Browser Extension](../../wallet/keplr/)，並到 [depub.space](https://depub.space/) 網站左下角點「Connect Wallet」。
...
請先登入 [Cosmostation Browser Extension](../../wallet/cosmostation/)，並到 [depub.space](https://depub.space/) 網站左下角點「Connect Wallet」。
