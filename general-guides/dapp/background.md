---
description: 以下為一些詞彙的解說，亦是憲法基礎，助你了解 LikeCoin DAO 機制
---
...
_LikeCoin DAO_ 政府去中心化的數據記錄，專為內容創作和資料產權而設計，提供高效、便宜，及尤其重要的獨立性。_LikeCoin chain_ 上的開放數據可在 [Ping.pub](../wallet/block-explorer/ping.pub.md) 上瀏覽。
...
就正如最初所言，_LikeCoin DAO_ 由社群共同擁有，自創世區塊開始便實現了「流動民主」( Liquid Democracy ) 的管治模式，透過所有 _Likers_ 授權 _驗證人_ 投票議案決定未來發展。
...
2021年8月18日 LikeCoin chain 升級到 FoTan 後，持份者可[直接就議案投票](../governance/direct-vote/)。
