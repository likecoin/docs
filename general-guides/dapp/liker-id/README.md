...
* [Email/Social ( Authcore )](../../../depub/register/) - Users can register a Liker ID on the [LikeCoin app](https://liker.land/getapp) to [manage](../../wallet/like-pay.md), [delegate](../../stake/delegation-of-likecoin/) LikeCoin, and check out [rewards](../creatortools/rewards.md). Users are advised to [export your seed words](../../../depub/register/export-seed-words.md) from Authcore and import them into [Keplr](../../wallet/keplr/) in order to manage their LikeCoin effectively.
