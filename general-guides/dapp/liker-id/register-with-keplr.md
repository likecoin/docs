...
Users can register a Liker ID using [Keplr](../../wallet/keplr/), allowing them to manage their [LikeCoin](https://like.co/) in a more decentralized manner and retain control of their private key.

Please note that once a Liker ID is confirmed, users cannot interchange between the two login methods ( Keplr or [through Email/Social, also known as Authcore](../../../depub/register/) ) for the same Liker ID.
...
| Use [dao.like.co to delegate LikeCoin](../../stake/delegation-of-likecoin/#delegate-via-dao.like.co)                                               | Use [LikeCoin app or dao.like.co to delegate LikeCoin](../../stake/delegation-of-likecoin/)                                                                                                                |
| Use [dao.like.co](https://dao.like.co/) to [deposit](../../governance/proposal-deposit.md) or [vote](../../governance/direct-vote/) for a proposal | Use [dao.like.co](https://dao.like.co/) to [deposit](../../governance/proposal-deposit.md) or [direct vote](../../governance/direct-vote/) for a proposal                                                  |
...
{% hint style="info" %}
Users can manage LikeCoin using [Cosmostation](../../wallet/cosmostation/) or [Leap](../../wallet/leap/), but currently, they cannot register a Liker ID with either of them.
{% endhint %}
