...
過往要把文章以 NFT 形式出版，工序很䌓複：作者須先把內容及元數據儲存在如 IPFS 等分散式空間或區塊鏈上，再上傳到 NFT 市場定價出售，過程中還要入手幾款不同用途的密碼貨幣。然而現在 [WordPress](https://wordpress.org/) 的用戶有福了，因為寫完文章以後只需按一個鍵，便能完成出版 NFT 的工序，內容立即上鏈，過程只需一分鐘！
...
* 鑄造 Writing NFT 後 [NFT 小部件 ( Widget )](../../depub/collect-writing-nft/nft-widget.md) 自動在文章下方顯示，讓讀者[收集 NFT](../../depub/collect-writing-nft/)，並整合 [LikeCoin button 讚賞鍵](creator/)功能
...
在出版 Writing NFT 前請安裝 [Keplr 瀏覽器擴充功能](../wallet/keplr/)並登入。此外亦需要 LikeCoin 進行操作，新用戶可使用[水龍頭](../faucet.md)獲得少量 LikeCoin，或查看[購買 LikeCoin](../trade/buy-likecoin.md) 的方式。
...
你也可以到 Liker Land [我的書架](../../depub/liker-land/bookshelf.md)查看你的創作。
