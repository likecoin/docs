...
Please install the [Keplr browser extension](../wallet/keplr/) and log in before publishing Writing NFT. A small amount of LikeCoin is required. New users can use the [faucet](../faucet.md) to get a small amount of LikeCoin for testing or learn how to [buy LikeCoin](../trade/buy-likecoin.md).
