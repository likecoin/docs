...
<figure><img src="../../.gitbook/assets/Batch Create QR Codes 1.png" alt=""><figcaption><p>輸入製作 QR Code 的內容</p></figcaption></figure>

**步驟二**：如需調整 QR Code 顯示樣式，可以點 **QR Code Appearance**。在 **Pick an icon** 可選擇使用 LikeCoin 圖示、NFC 圖示或不使用圖示；在 **Pick a color** 可選擇顏色。

<figure><img src="../../.gitbook/assets/Batch Create QR Codes 2.png" alt=""><figcaption><p>Pick an icon 選擇圖示</p></figcaption></figure>

<figure><img src="../../.gitbook/assets/Batch Create QR Codes 3.png" alt=""><figcaption><p>Pick a color 選擇顏色</p></figcaption></figure>
