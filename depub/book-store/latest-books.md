...
After completing the setup, the message "Append ?from=@`[your Liker ID`] in any bookstore page to earn commission from book sales" will appear. Click "Copy" to copy the new book promotion link. Then, share it to earn Book Affiliation Program promotional commissions.
