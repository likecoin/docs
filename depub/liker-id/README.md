...
* [Email/Social ( Authcore )](register/) - Users can register a Liker ID on the [LikeCoin app](https://liker.land/getapp) to [manage](../../general-guides/wallet/like-pay.md), [delegate](../../general-guides/stake/delegation-of-likecoin/) LikeCoin, and check out [rewards](../../general-guides/dapp/creatortools/rewards.md). Users are advised to [export your seed words](register/export-seed-words.md) from Authcore and import them into [Keplr](../../general-guides/wallet/keplr/) in order to manage their LikeCoin effectively.
