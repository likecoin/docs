---
description: 使用 Cosmostation 以文章網址出版 Writing NFT
---
...
<figure><img src="../../.gitbook/assets/NFT Portal Cosmotation.png" alt=""><figcaption><p>以 Cosmostation 登入 NFT Portal</p></figcaption></figure>
...
假如文章並未註冊 [ISCN](../what-is-iscn/)，請直接把文章網址輸入空格並點「Register ISCN」。
...
<figure><img src="../../.gitbook/assets/NFT Portal 3 Cosmostation.png" alt=""><figcaption><p>Cosmostation 視窗彈出一律點「Confirm」</p></figcaption></figure>
...
將彈出 Cosmostation 視窗，請點「Confirm」進行簽署以註冊 ISCN ID、Arweave ID、Class ID 及鑄造 NFT。
...
出現 Completed! 及 3D 封面圖即代表 NFT 已鑄造完成，如網站未曾安裝 [LikeCoin button 讚賞鍵](../../user-guide/creator/)可直接貼上 Embed NFT widget into your site 的代碼，即可在任何網頁展示 [NFT 小部件](../liker-land-web/nft-widget.md)。
...
<figure><img src="../../.gitbook/assets/NFT Portal 6-3.png" alt=""><figcaption><p>查看已出版的 Writing NFT</p></figcaption></figure>

{% hint style="info" %}
留意如果將網址直接以這個方式註冊 ISCN 並出版 Writing NFT，系統會自動抓取文章標題及內容作為元數據。

**如希望作品擁有詳盡元數據，請先** [**註冊 ISCN**](../what-is-iscn/app.like.co/) **再**[**以 ISCN ID 出版 Writing NFT**](iscn-id.md)**。**&#x20;
{% endhint %}
