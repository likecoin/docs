...
在 [Cosmostation app](../../general-guides/wallet/cosmostation-mobile/) 點「Wallet Connect」調用鏡頭，並掃瞄二維碼。
...
**如希望作品擁有詳盡元數據，請先** [**註冊 ISCN**](../what-is-iscn/app.like.co/) **再以** [**ISCN ID 出版 Writing NFT**](iscn-id.md)**。**&#x20;
{% endhint %}
