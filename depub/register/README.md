...
{% hint style="info" %}
Users can also [export their seed words from Authcore](export-seed-words.md) and import them into [Keplr](../../general-guides/wallet/keplr/) or other wallets to manage their LikeCoin.
{% endhint %}
