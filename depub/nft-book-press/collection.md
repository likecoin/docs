...
到 [LikeCoin NFT Book Press](https://likecoin.github.io/nft-book-press/) 網站，進入網站後左左下角「Sign in」連結錢包，再點「[Manage Book Collection](https://likecoin.github.io/nft-book-press/nft-book-store/collection)」，
...
* **Books in Collection** - 輸入電子書的 Class ID，再點「**Add**」
* **Total number of packages available for sale** - 可供銷售的電子書套裝數量

餘下步驟與上架電子書相同，設定完成後點「**Submit**」即可設定電子書套裝。
