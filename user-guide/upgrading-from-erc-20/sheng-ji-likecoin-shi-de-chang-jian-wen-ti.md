...
### **錯誤：「請用已綁定你的 Liker ID 的以太坊地址 \[0x...\] 來簽署」**
...
### **升級過程中，MetaMask 及 like.co/in 網頁上顯示的 LikeCoin 數變成 0 了！**
