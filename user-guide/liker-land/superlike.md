...
depub.space 是 LikeCoin 生態內的去中心社交媒體，每則推文都是一筆鏈上記錄，只需以 [Keplr](../../general-guides/wallet/keplr/) 或 [Cosmostation 瀏覽器擴充功能錢包](../../general-guides/wallet/cosmostation/)登入或使用 [LikeCoin app](download.md) 進行 Wallet Connect 即可發文，無需註冊，預設私隱。
