...
depub.space 是 LikeCoin 生態內的去中心社交媒體，每則推文都是一筆鏈上記錄，只需 [Keplr](../../guides/wallet/keplr/) 或 [Cosmostation 瀏覽器錢包](../../guides/wallet/cosmostation/)登入或使用 [Liker Land app](download.md) 進行 Wallet Connect 即可使用，無需註冊，預設私隱。
