...
* 使用 [app.like.co](https://docs.like.co/v/zh/guides/decentralized-publishing/app.like.co) 或 [ISCN Batch Upload](https://docs.like.co/v/zh/guides/decentralized-publishing/iscn-batch-uploader) 註冊 ISCN
