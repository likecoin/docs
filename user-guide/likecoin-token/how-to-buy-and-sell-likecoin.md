...
部份交易所尚未正式支援 LikeCoin chain 上的 LikeCoin，掛牌的仍然是舊版的 LikeCoin ERC-20，例 [IDEX](https://idex.market/eth/like)。BitAsset 及 MyEthShop 則提供 ERC-20 接口供交易之用，然而交易過後的 LikeCoin 將會變成新版。
