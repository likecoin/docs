...
登入 [Liker Land](https://liker.land/) 並前住 [https://like.co/in/settings，到](https://like.co/in/settings，到) Authcore 設定的部份，點選「安全設定」；或於 Liker Land 手機應用程式選畫面右下角的帳戶頭像按 \[Account Settings\]，再點 「裝置 / \[Devices\]。
