...
* [一般方法 ( Authcore )](register/)－雖然用戶可以 [Liker Land 手機應用程式](../liker-land/download.md) 或 [網頁版](https://liker.land/) 註冊 Liker ID 及使用[轉帳](../../guides/wallet/like-pay.md)、[委託](../../guides/stake/delegation-of-likecoin.md)及[查看讚賞成就](../creatortools/rewards/)等各種功能，然而此登入方式將會慢慢淡出。建議用戶立即從 Authcore 匯出你的助記詞並導入 [Keplr](../../guides/wallet/keplr.md)，以便管理你的 LikeCoin。
