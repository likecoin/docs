...
[depub.space](https://depub.space/) is a Web3 decentralized Twitter that requires only a small amount of LIKE to directly “DePub” (decentralized-publish) text and images to blockchain and IPFS. Users can connect their [Keplr](../../general-guides/wallet/keplr/) wallet, [Liker Land app](../liker-land/download.md) or [Cosmostation](../../general-guides/wallet/cosmostation/) to post messages on depub.space.
...
Login your [Cosmostation](../../general-guides/wallet/cosmostation/) and go to [depub.space](https://depub.space/), then click "Connect Wallet" at the lower left hand corner.
